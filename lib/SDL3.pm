...
=cut
    ...
    sub _enum_and_export( $name, $values ) {
        ...
        for my $enum (@$values) {
            ...
            #~ ( $enum, $value ) = ref $enum ? (@$enum) : ( $enum, $value );
            #~ $value = $value->() if __PACKAGE__->can($value);
            #~ warn $enum;
            #~ *{$enum} = sub() {$value};
            #~ $value++;
...
Simple log messages with priorities and categories. A message's SDL_LogPriority signifies how important the message is.
A message's SDL_LogCategory signifies from what domain it belongs to. Every category has a minimum priority specified:
...
=cut
    ...
    sub _platform() {    # Based on sdl-main/include/sdl3/sdl_platform.h
        state $done++ && return;
        _platform_defines();
        #
...
=cut
    ...
    sub _scancode() {
        ...
        _enum_and_export SDL_Scancode => [
            ...
            [ SDL_SCANCODE_9                    => 35 ],
            [ SDL_SCANCODE_0                    => 36 ],
            [ SDL_SCANCODE_RETURN               => 37 ],
            [ SDL_SCANCODE_ESCAPE               => 38 ],
            [ SDL_SCANCODE_BACKSPACE            => 39 ],
            [ SDL_SCANCODE_TAB                  => 40 ],
            [ SDL_SCANCODE_SPACE                => 41 ],
            [ SDL_SCANCODE_MINUS                => 42 ],
            [ SDL_SCANCODE_EQUALS               => 43 ],
            [ SDL_SCANCODE_LEFTBRACKET          => 44 ],
            [ SDL_SCANCODE_RIGHTBRACKET         => 45 ],
            [ SDL_SCANCODE_BACKSLASH            => 46 ],
            [ SDL_SCANCODE_NONUSHASH            => 47 ],
            [ SDL_SCANCODE_SEMICOLON            => 48 ],
            [ SDL_SCANCODE_APOSTROPHE           => 49 ],
            [ SDL_SCANCODE_GRAVE                => 50 ],
            [ SDL_SCANCODE_COMMA                => 51 ],
            [ SDL_SCANCODE_PERIOD               => 52 ],
            [ SDL_SCANCODE_SLASH                => 53 ],
            [ SDL_SCANCODE_CAPSLOCK             => 54 ],
            [ SDL_SCANCODE_F1                   => 55 ],
            [ SDL_SCANCODE_F2                   => 56 ],
            [ SDL_SCANCODE_F3                   => 57 ],
            [ SDL_SCANCODE_F4                   => 58 ],
            ...
            [ SDL_SCANCODE_F11                  => 65 ],
            [ SDL_SCANCODE_F12                  => 66 ],
            [ SDL_SCANCODE_PRINTSCREEN          => 67 ],
            [ SDL_SCANCODE_SCROLLLOCK           => 68 ],
            [ SDL_SCANCODE_PAUSE                => 69 ],
            [ SDL_SCANCODE_INSERT               => 70 ],
            [ SDL_SCANCODE_HOME                 => 71 ],
            [ SDL_SCANCODE_PAGEUP               => 72 ],
            [ SDL_SCANCODE_DELETE               => 73 ],
            [ SDL_SCANCODE_END                  => 74 ],
            [ SDL_SCANCODE_PAGEDOWN             => 75 ],
            [ SDL_SCANCODE_RIGHT                => 76 ],
            [ SDL_SCANCODE_LEFT                 => 77 ],
            [ SDL_SCANCODE_DOWN                 => 78 ],
            [ SDL_SCANCODE_UP                   => 79 ],
            [ SDL_SCANCODE_NUMLOCKCLEAR         => 80 ],
            [ SDL_SCANCODE_KP_DIVIDE            => 81 ],
            [ SDL_SCANCODE_KP_MULTIPLY          => 82 ],
            [ SDL_SCANCODE_KP_MINUS             => 83 ],
            [ SDL_SCANCODE_KP_PLUS              => 84 ],
            [ SDL_SCANCODE_KP_ENTER             => 85 ],
            [ SDL_SCANCODE_KP_1                 => 86 ],
            [ SDL_SCANCODE_KP_2                 => 87 ],
            [ SDL_SCANCODE_KP_3                 => 88 ],
            [ SDL_SCANCODE_KP_4                 => 89 ],
            [ SDL_SCANCODE_KP_5                 => 90 ],
            [ SDL_SCANCODE_KP_6                 => 91 ],
            [ SDL_SCANCODE_KP_7                 => 92 ],
            [ SDL_SCANCODE_KP_8                 => 93 ],
            [ SDL_SCANCODE_KP_9                 => 94 ],
            [ SDL_SCANCODE_KP_0                 => 95 ],
            [ SDL_SCANCODE_KP_PERIOD            => 96 ],
            [ SDL_SCANCODE_NONUSBACKSLASH       => 97 ],
            [ SDL_SCANCODE_APPLICATION          => 98 ],
            [ SDL_SCANCODE_POWER                => 99 ],
            [ SDL_SCANCODE_KP_EQUALS            => 100 ],
            [ SDL_SCANCODE_F13                  => 101 ],
            [ SDL_SCANCODE_F14                  => 102 ],
            [ SDL_SCANCODE_F15                  => 103 ],
            [ SDL_SCANCODE_F16                  => 104 ],
            [ SDL_SCANCODE_F17                  => 105 ],
            [ SDL_SCANCODE_F18                  => 106 ],
            [ SDL_SCANCODE_F19                  => 107 ],
            [ SDL_SCANCODE_F20                  => 108 ],
            [ SDL_SCANCODE_F21                  => 109 ],
            [ SDL_SCANCODE_F22                  => 110 ],
            [ SDL_SCANCODE_F23                  => 111 ],
            [ SDL_SCANCODE_F24                  => 112 ],
            [ SDL_SCANCODE_EXECUTE              => 113 ],
            [ SDL_SCANCODE_HELP                 => 114 ],
            [ SDL_SCANCODE_MENU                 => 115 ],
            [ SDL_SCANCODE_SELECT               => 116 ],
            [ SDL_SCANCODE_STOP                 => 117 ],
            [ SDL_SCANCODE_AGAIN                => 118 ],
            [ SDL_SCANCODE_UNDO                 => 119 ],
            [ SDL_SCANCODE_CUT                  => 120 ],
            [ SDL_SCANCODE_COPY                 => 121 ],
            [ SDL_SCANCODE_PASTE                => 122 ],
            [ SDL_SCANCODE_FIND                 => 123 ],
            [ SDL_SCANCODE_MUTE                 => 124 ],
            [ SDL_SCANCODE_VOLUMEUP             => 125 ],
            [ SDL_SCANCODE_VOLUMEDOWN           => 126 ],
            [ SDL_SCANCODE_KP_COMMA             => 127 ],
            [ SDL_SCANCODE_KP_EQUALSAS400       => 128 ],
            [ SDL_SCANCODE_INTERNATIONAL1       => 129 ],
            [ SDL_SCANCODE_INTERNATIONAL2       => 130 ],
            [ SDL_SCANCODE_INTERNATIONAL3       => 131 ],
            [ SDL_SCANCODE_INTERNATIONAL4       => 132 ],
            [ SDL_SCANCODE_INTERNATIONAL5       => 133 ],
            [ SDL_SCANCODE_INTERNATIONAL6       => 134 ],
            [ SDL_SCANCODE_INTERNATIONAL7       => 135 ],
            [ SDL_SCANCODE_INTERNATIONAL8       => 136 ],
            [ SDL_SCANCODE_INTERNATIONAL9       => 137 ],
            [ SDL_SCANCODE_LANG1                => 138 ],
            [ SDL_SCANCODE_LANG2                => 139 ],
            [ SDL_SCANCODE_LANG3                => 140 ],
            [ SDL_SCANCODE_LANG4                => 141 ],
            [ SDL_SCANCODE_LANG5                => 142 ],
            [ SDL_SCANCODE_LANG6                => 143 ],
            [ SDL_SCANCODE_LANG7                => 144 ],
            [ SDL_SCANCODE_LANG8                => 145 ],
            [ SDL_SCANCODE_LANG9                => 146 ],
            [ SDL_SCANCODE_ALTERASE             => 147 ],
            [ SDL_SCANCODE_SYSREQ               => 148 ],
            [ SDL_SCANCODE_CANCEL               => 149 ],
            [ SDL_SCANCODE_CLEAR                => 150 ],
            [ SDL_SCANCODE_PRIOR                => 151 ],
            [ SDL_SCANCODE_RETURN2              => 152 ],
            [ SDL_SCANCODE_SEPARATOR            => 153 ],
            [ SDL_SCANCODE_OUT                  => 154 ],
            [ SDL_SCANCODE_OPER                 => 155 ],
            [ SDL_SCANCODE_CLEARAGAIN           => 156 ],
            [ SDL_SCANCODE_CRSEL                => 157 ],
            [ SDL_SCANCODE_EXSEL                => 158 ],
            [ SDL_SCANCODE_KP_00                => 159 ],
            [ SDL_SCANCODE_KP_000               => 160 ],
            [ SDL_SCANCODE_THOUSANDSSEPARATOR   => 161 ],
            [ SDL_SCANCODE_DECIMALSEPARATOR     => 162 ],
            [ SDL_SCANCODE_CURRENCYUNIT         => 163 ],
            [ SDL_SCANCODE_CURRENCYSUBUNIT      => 164 ],
            [ SDL_SCANCODE_KP_LEFTPAREN         => 165 ],
            [ SDL_SCANCODE_KP_RIGHTPAREN        => 166 ],
            [ SDL_SCANCODE_KP_LEFTBRACE         => 167 ],
            [ SDL_SCANCODE_KP_RIGHTBRACE        => 168 ],
            [ SDL_SCANCODE_KP_TAB               => 169 ],
            [ SDL_SCANCODE_KP_BACKSPACE         => 170 ],
            [ SDL_SCANCODE_KP_A                 => 171 ],
            [ SDL_SCANCODE_KP_B                 => 172 ],
            [ SDL_SCANCODE_KP_C                 => 173 ],
            [ SDL_SCANCODE_KP_D                 => 174 ],
            [ SDL_SCANCODE_KP_E                 => 175 ],
            [ SDL_SCANCODE_KP_F                 => 176 ],
            [ SDL_SCANCODE_KP_XOR               => 177 ],
            [ SDL_SCANCODE_KP_POWER             => 178 ],
            [ SDL_SCANCODE_KP_PERCENT           => 179 ],
            [ SDL_SCANCODE_KP_LESS              => 180 ],
            [ SDL_SCANCODE_KP_GREATER           => 181 ],
            [ SDL_SCANCODE_KP_AMPERSAND         => 182 ],
            [ SDL_SCANCODE_KP_DBLAMPERSAND      => 183 ],
            [ SDL_SCANCODE_KP_VERTICALBAR       => 184 ],
            [ SDL_SCANCODE_KP_DBLVERTICALBAR    => 185 ],
            [ SDL_SCANCODE_KP_COLON             => 186 ],
            [ SDL_SCANCODE_KP_HASH              => 187 ],
            [ SDL_SCANCODE_KP_SPACE             => 188 ],
            [ SDL_SCANCODE_KP_AT                => 189 ],
            [ SDL_SCANCODE_KP_EXCLAM            => 190 ],
            [ SDL_SCANCODE_KP_MEMSTORE          => 191 ],
            [ SDL_SCANCODE_KP_MEMRECALL         => 192 ],
            [ SDL_SCANCODE_KP_MEMCLEAR          => 193 ],
            [ SDL_SCANCODE_KP_MEMADD            => 194 ],
            [ SDL_SCANCODE_KP_MEMSUBTRACT       => 195 ],
            [ SDL_SCANCODE_KP_MEMMULTIPLY       => 196 ],
            [ SDL_SCANCODE_KP_MEMDIVIDE         => 197 ],
            [ SDL_SCANCODE_KP_PLUSMINUS         => 198 ],
            [ SDL_SCANCODE_KP_CLEAR             => 199 ],
            [ SDL_SCANCODE_KP_CLEARENTRY        => 200 ],
            [ SDL_SCANCODE_KP_BINARY            => 201 ],
            [ SDL_SCANCODE_KP_OCTAL             => 202 ],
            [ SDL_SCANCODE_KP_DECIMAL           => 203 ],
            [ SDL_SCANCODE_KP_HEXADECIMAL       => 204 ],
            [ SDL_SCANCODE_LCTRL                => 205 ],
            [ SDL_SCANCODE_LSHIFT               => 206 ],
            [ SDL_SCANCODE_LALT                 => 207 ],
            [ SDL_SCANCODE_LGUI                 => 208 ],
            [ SDL_SCANCODE_RCTRL                => 209 ],
            [ SDL_SCANCODE_RSHIFT               => 210 ],
            [ SDL_SCANCODE_RALT                 => 211 ],
            [ SDL_SCANCODE_RGUI                 => 212 ],
            [ SDL_SCANCODE_MODE                 => 213 ],
            [ SDL_SCANCODE_SLEEP                => 214 ],
            [ SDL_SCANCODE_WAKE                 => 215 ],
            [ SDL_SCANCODE_CHANNEL_INCREMENT    => 216 ],
            [ SDL_SCANCODE_CHANNEL_DECREMENT    => 217 ],
            [ SDL_SCANCODE_MEDIA_PLAY           => 218 ],
            [ SDL_SCANCODE_MEDIA_PAUSE          => 219 ],
            [ SDL_SCANCODE_MEDIA_RECORD         => 220 ],
            [ SDL_SCANCODE_MEDIA_FAST_FORWARD   => 221 ],
            [ SDL_SCANCODE_MEDIA_REWIND         => 222 ],
            [ SDL_SCANCODE_MEDIA_NEXT_TRACK     => 223 ],
            [ SDL_SCANCODE_MEDIA_PREVIOUS_TRACK => 224 ],
            [ SDL_SCANCODE_MEDIA_STOP           => 225 ],
            [ SDL_SCANCODE_MEDIA_EJECT          => 226 ],
            [ SDL_SCANCODE_MEDIA_PLAY_PAUSE     => 227 ],
            [ SDL_SCANCODE_MEDIA_SELECT         => 228 ],
            [ SDL_SCANCODE_AC_NEW               => 229 ],
            [ SDL_SCANCODE_AC_OPEN              => 230 ],
            [ SDL_SCANCODE_AC_CLOSE             => 231 ],
            [ SDL_SCANCODE_AC_EXIT              => 232 ],
            [ SDL_SCANCODE_AC_SAVE              => 233 ],
            [ SDL_SCANCODE_AC_PRINT             => 234 ],
            [ SDL_SCANCODE_AC_PROPERTIES        => 235 ],
            [ SDL_SCANCODE_AC_SEARCH            => 236 ],
            [ SDL_SCANCODE_AC_HOME              => 237 ],
            [ SDL_SCANCODE_AC_BACK              => 238 ],
            [ SDL_SCANCODE_AC_FORWARD           => 239 ],
            [ SDL_SCANCODE_AC_STOP              => 240 ],
            [ SDL_SCANCODE_AC_REFRESH           => 241 ],
            [ SDL_SCANCODE_AC_BOOKMARKS         => 242 ],
            [ SDL_SCANCODE_SOFTLEFT             => 243 ],
            [ SDL_SCANCODE_SOFTRIGHT            => 244 ],
            [ SDL_SCANCODE_CALL                 => 245 ],
            [ SDL_SCANCODE_ENDCALL              => 246 ],
            [ SDL_SCANCODE_RESERVED             => 247 ],
            [ SDL_SCANCODE_COUNT                => 248 ],
        ];
    }
